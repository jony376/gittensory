...
export type GovernorApiDeps = {
  /** Import of `packages/loopover-miner/lib/governor-state.js` — injectable so tests never touch a real store. */
...
const defaultDeps: GovernorApiDeps = {
  loadGovernorStateModule: () =>
    import("../../packages/loopover-miner/lib/governor-state.js") as Promise<GovernorStateModule>,
